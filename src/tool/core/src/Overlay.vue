...
import UIDevtoolOverlay from "./components/Mark.vue";
import { ref } from "vue";
...
export default {
  ...
  setup() {
    ...
    const updateTargetElement = (element: HTMLElement) => {
  ...
  methods: {
    ...
    isKeyActive(key, event) {
      console.log(`key:`, key.charAt(0).toUpperCase());
      switch (key) {
        case "shift":
        case "control":
        case "alt":
    ...
    updateLinkParams(e) {
      ...
      if (targetNode) {
        ...
        this.updateTargetElement(targetNode);
