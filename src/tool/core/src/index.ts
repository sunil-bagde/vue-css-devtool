    ...
    },
    {
      ...
      transform(code) {
        if (code.includes('_interopVNode'))
          return
        if (!code.includes('data-v-src-location'))
          return
...
function _interopVNode(vnode) {
  if (vnode && vnode.props && 'data-v-src-location' in vnode.props) {
    const data = vnode.props['data-v-src-location']
    delete vnode.props['data-v-src-location']
